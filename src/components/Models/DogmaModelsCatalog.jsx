...
export const DogmaModelsCatalog = ({ onOpenBooking }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 inset-x-0 max-w-7xl mx-auto px-6 sm:px-12 md:px-16 select-none pointer-events-none overflow-hidden flex flex-col items-center justify-center opacity-[0.022] sm:opacity-[0.028] leading-none font-display font-black tracking-tight">
      ...
      {/* Atmospheric Ambient Lighting Blobs with Soft Insets */}
      <div
        className="absolute top-1/4 left-1/4 -translate-x-1/2 w-[600px] h-[600px] rounded-full blur-[170px] pointer-events-none opacity-20 transition-all duration-1000"
        style={{ backgroundColor: currentColorway.colorHex || '#E4002B' }}
      />
      <div className="absolute bottom-1/3 right-1/4 translate-x-1/2 w-[500px] h-[500px] bg-[#00F0FF]/10 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="relative z-10 mb-14">
        {/* Kicker Index Bar */}
        <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-white/10 mb-6 font-mono text-[11px] tracking-[0.25em] text-zinc-400 uppercase">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#00F0FF] font-semibold">FACTORY REPERTORY</span>
            <span className="text-zinc-600">//</span>
            <span>TREVISO RACING DIVISION</span>
          </div>

          <div className="flex items-center gap-4 text-zinc-500 hidden sm:flex">
            <span>HOMOLOGATION: UCI 700C</span>
            <span className="text-zinc-600">•</span>
            <span className="text-[#E4002B] font-bold">5 EDITIONS ARCHIVE</span>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div>
            <span className="block font-mono text-xs uppercase tracking-[0.3em] text-[#FF5E0E] font-bold mb-2">
              FIVE MASTERWORK CONFIGURATIONS
            </span>
            <h2 className="font-display text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-white uppercase leading-[0.95]">
              DISTINCTION IN <br />
          ...
          <p className="max-w-md text-sm sm:text-base text-zinc-400 font-sans font-light leading-relaxed">
      ...
      <div className="relative z-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 mb-10">
        {PINARELLO_MODELS.map((model, idx) => {
          ...
          return (
            <button
              ...
              className={`relative text-left p-4 sm:p-5 rounded-2xl transition-all duration-300 group overflow-hidden border ${
                isSelected
                  ? 'bg-white/[0.08] border-white/30 shadow-[0_0_30px_rgba(255,255,255,0.1)]'
            ...
            >
              ...
              <div className="flex items-center justify-between font-mono text-[10px] tracking-widest uppercase mb-3">
                ...
                <span className="px-1.5 py-0.5 rounded bg-white/5 text-zinc-400 text-[9px]">
                  {model.brand}
                </span>
              </div>

              {/* Middle: Short Name */}
              <div className="font-display text-sm sm:text-base font-extrabold text-white tracking-tight uppercase leading-tight line-clamp-2">
                {model.shortName}
              </div>
              ...
              <div className="mt-3 pt-3 border-t border-white/5 flex items-center justify-between">
                ...
                <span
                  ...
                  style={{
                    ...
                    boxShadow: isSelected ? '0 0 8px #00F0FF' : 'none',
                  }}
                />
              </div>
            </button>
      ...
      <div className="relative z-10 bg-[#07080A]/90 border border-white/10 rounded-3xl p-6 sm:p-10 lg:p-12 backdrop-blur-3xl shadow-[0_30px_100px_rgba(0,0,0,0.9)] overflow-hidden">
        ...
        <div className="relative z-20 flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs text-zinc-400 hidden sm:inline">
              FINISH CODE: <strong className="text-white">{currentModel.finishCode}</strong>
            </span>
          </div>

          {/* Interactive Mode Toggles */}
          <div className="flex items-center bg-white/5 p-1 rounded-xl border border-white/10 font-mono text-[11px] uppercase">
            <button
              onClick={() => {
                setActiveTab('specs');
                sfx.playClick();
            ...
            >
              <Activity className="w-3 h-3 text-[#FF5E0E]" />
              Telemetry
            </button>
          </div>
        </div>
        ...
        <div className="relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mt-8">
          ...
          >
            ...
            <div
              className="absolute w-80 sm:w-[460px] h-80 sm:h-[460px] rounded-full blur-[120px] transition-all duration-700 pointer-events-none opacity-40"
              style={{
            ...
            <div className="absolute bottom-6 w-[80%] flex items-center justify-between font-mono text-[9px] text-zinc-600 uppercase tracking-widest pointer-events-none">
              <span className="flex items-center gap-1">
                <span className="w-1.5 h-1.5 rounded-full bg-[#00F0FF]" />
                FRONT AXLE: 12×100MM
              </span>
              <div className="flex-1 mx-4 h-[1px] bg-gradient-to-r from-transparent via-white/20 to-transparent relative">
                <span className="absolute left-1/2 -top-2.5 -translate-x-1/2 px-2 bg-[#07080A] text-[8.5px] text-zinc-500">
                  WHEELBASE: 974 MM
                </span>
              </div>
              <span className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      className={`relative group flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-full border backdrop-blur-md transition-all duration-300 ${
                        isActive
                          ...
                          : 'bg-black/60 text-white border-white/30 hover:border-white hover:scale-110 hover:bg-black/80'
                      }`}
                      title={spot.title}
                    >
                      <span className="absolute inset-0 rounded-full animate-ping opacity-30 bg-[#00F0FF]" />
                      <Info className="w-3.5 h-3.5 stroke-[2.5]" />
                    </button>

                    {/* Active Hotspot Glass Popover Card */}
                    {isActive && (
                      <div className="absolute left-1/2 -top-3 -translate-x-1/2 -translate-y-full w-60 sm:w-72 p-4 rounded-2xl bg-[#0F1218]/95 border border-[#00F0FF]/40 text-white backdrop-blur-2xl shadow-2xl z-40 animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="font-display text-xs sm:text-sm font-extrabold uppercase tracking-tight text-white mb-1">
                          {spot.title}
                        </div>
            ...
            <div className="relative z-20 mt-8 flex flex-col items-center gap-3 bg-[#0B0D12]/90 border border-white/15 px-6 py-3.5 rounded-2xl backdrop-blur-2xl shadow-2xl">
              <div className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-wider text-zinc-400">
                ...
                <span className="px-1.5 py-0.5 rounded bg-white/10 text-[9px] text-[#00F0FF]">
                  ...
                  return (
                    <button
                      ...
                      className={`relative group w-8 h-8 sm:w-9 sm:h-9 rounded-full overflow-hidden border transition-all duration-300 flex items-center justify-center ${
                        isSelected
                          ? 'scale-125 border-white ring-2 ring-[#00F0FF] ring-offset-2 ring-offset-black shadow-[0_0_15px_rgba(0,240,255,0.5)]'
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 font-sans mt-3 leading-relaxed font-light">
            ...
            {activeTab === 'specs' && (
              <div className="space-y-2.5 font-mono text-xs animate-in fade-in duration-300">
                {/* Groupset */}
                <div className="p-3.5 rounded-xl bg-white/[0.03] border border-white/[0.08] hover:border-white/20 transition-colors flex justify-between items-center group">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <div className="p-3 rounded-xl bg-white/[0.03] border border-white/[0.08]">
                    <span className="block text-[10px] text-zinc-500 uppercase">CHASSIS MASS</span>
                    <span className="font-display text-base font-black text-[#00F0FF]">
                      {currentModel.weight}
                    </span>
                    <span className="text-[10px] text-zinc-500 block">({currentModel.weightLbs})</span>
                  </div>
                  <div className="p-3 rounded-xl bg-white/[0.03] border border-white/[0.08]">
                    <span className="block text-[10px] text-zinc-500 uppercase">MAX TIRE CLEARANCE</span>
                    <span className="font-display text-base font-black text-white">
                      700 × 30c
                    </span>
                    <span className="text-[10px] text-zinc-500 block">All-Road Aerodynamic</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-5">
              ...
              <div className="flex flex-col sm:flex-row items-stretch gap-2.5">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/15 text-zinc-300 hover:text-white font-mono text-xs uppercase font-bold transition-all hover:scale-105"
                >

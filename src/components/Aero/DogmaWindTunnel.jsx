...
export const DogmaWindTunnel = () => {
  ...
  return (
    <section
      id="windtunnel"
      className="relative w-full py-28 sm:py-36 overflow-hidden bg-gradient-to-b from-[#0e1322] via-[#12192a] to-[#0f1424] border-t border-white/[0.08]"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-10 sm:mb-16">
          <div className="inline-flex items-center gap-1.5 sm:gap-3 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-white/5 border border-white/10 text-zinc-300 text-[9.5px] xs:text-[10.5px] sm:text-[11px] font-mono tracking-[0.15em] sm:tracking-[0.2em] uppercase mb-4 sm:mb-5 backdrop-blur-md shadow-inner font-bold">
            <Wind className="w-3 sm:w-3.5 h-3 sm:h-3.5 animate-pulse text-[#E4002B]" />
            <span>04 // AERODYNAMICS // CFD TUNNEL // TREVISO R&D</span>
          </div>

          <h2 className="font-display font-black text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight text-white uppercase leading-[1.05]">
            DYNAMIC CFD{' '}
          ...
          <p className="mt-3 sm:mt-5 text-xs xs:text-sm sm:text-base md:text-lg text-zinc-200 font-sans max-w-2xl mx-auto leading-relaxed font-normal">
          ...
          <div className="mt-4 sm:mt-6 flex flex-wrap items-center justify-center gap-2 sm:gap-3 font-mono text-[10px] sm:text-xs">
            <span className="px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full bg-white/[0.08] border border-white/20 text-white font-bold">
        ...
        <div className="bg-gradient-to-b from-white/[0.08] via-white/[0.03] to-[#081522]/90 border border-white/15 rounded-2xl sm:rounded-3xl overflow-hidden backdrop-blur-3xl shadow-[0_35px_100px_rgba(0,0,0,0.6)]">
          {/* Top Visualizer Chamber */}
          <div className="relative w-full h-[290px] xs:h-[340px] sm:h-[440px] md:h-[520px] lg:h-[580px] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-zinc-800/80 via-[#061422] to-[#030a12] border-b border-white/15 flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-x-0 bottom-0 h-28 sm:h-44 bg-gradient-to-t from-black via-black/80 to-transparent pointer-events-none z-10" />
            <div className="absolute top-0 left-0 w-48 sm:w-96 h-full bg-gradient-to-r from-[#00F0FF]/15 to-transparent pointer-events-none" />
            <div
              className="absolute top-0 right-0 w-48 sm:w-96 h-full pointer-events-none transition-colors duration-700 opacity-20"
              style={{ background: `linear-gradient(to left, ${activeLivery.colorHex}66, transparent)` }}
            />

            {/* Dynamic Center Stage Livery Aura */}
            <div
              className="absolute w-64 sm:w-[480px] h-64 sm:h-[480px] rounded-full blur-[90px] sm:blur-[120px] pointer-events-none opacity-35 transition-all duration-700"
            ...
            <div
              className="relative z-10 w-[88%] xs:w-[84%] max-w-[660px] aspect-[16/10] flex items-center justify-center transition-transform duration-500 ease-out"
              style={{
            ...
            >
              ...
              <img
                ...
                key={activeLivery.id}
                className="w-full h-full object-contain filter drop-shadow-[0_20px_35px_rgba(0,0,0,0.98)] select-none pointer-events-none transition-all duration-500"
              />

              {/* Realistic Ground Floor Reflection Shadow */}
              <div className="absolute -bottom-6 sm:-bottom-7 left-1/2 -translate-x-1/2 w-[92%] h-8 sm:h-10 bg-black/90 rounded-full blur-xl pointer-events-none" />
                  ...
                  return (
                    ...
                    >
                      <span className="relative flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center">
                        ...
                        />
                        <span
                          className={`relative inline-flex rounded-full h-3.5 w-3.5 sm:h-4 sm:w-4 border-2 border-white transition-transform duration-300 ${
                            isSelected
            ...
            <div className="hidden md:flex absolute top-6 left-6 z-20 items-center gap-2 font-mono text-xs">
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-[11px] text-white font-semibold transition-colors shadow-md backdrop-blur-md cursor-pointer"
              >
            ...
            <div className="hidden md:flex absolute top-6 right-6 z-20 items-center gap-2 bg-black/90 border border-white/25 p-2 rounded-full backdrop-blur-md shadow-2xl">
              {WIND_TUNNEL_LIVERIES.map((liv) => (
                <button
                  ...
                  className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full border-2 transition-all duration-300 cursor-pointer ${
                    activeLivery.id === liv.id
            ...
            <div className="hidden md:flex absolute bottom-6 left-6 right-6 z-20 items-center justify-between gap-4 bg-gradient-to-r from-black/95 via-zinc-950/95 to-black/95 border border-white/20 p-5 rounded-2xl backdrop-blur-2xl shadow-2xl">
              <div>
                ...
                <div className="font-display text-3xl lg:text-4xl font-black text-white mt-0.5">
          ...
          <div className="p-4 xs:p-5 sm:p-8 lg:p-10 bg-black/40 border-t border-white/15">
            <div className="flex items-center justify-between mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-white/15">
              <div className="flex items-center gap-2">
                <Sliders className="w-3.5 sm:w-4 h-3.5 sm:h-4 text-cyan-300" />
                <span className="font-mono text-[10px] sm:text-xs uppercase tracking-widest text-zinc-200 font-bold">
                  Virtual CFD Telemetry Inputs
                </span>
              </div>
              <button
                onClick={handleResetTelemetry}
                className="flex items-center gap-1.5 text-[10px] sm:text-xs font-mono text-zinc-300 hover:text-white transition-colors font-bold cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-6">
              ...
              <div className="bg-white/[0.05] border border-white/15 p-3.5 sm:p-5 rounded-xl sm:rounded-2xl hover:border-white/25 transition-colors">
                <div className="flex justify-between items-center text-xs font-mono mb-2 sm:mb-3">
                  ...
                  <span className="text-white font-black text-xs sm:text-sm bg-white/10 px-2 sm:px-2.5 py-0.5 rounded-lg border border-white/15">
                    {riderPowerWatts} W
                  </span>
                </div>
                <input
                  ...
                  className="w-full accent-[#FF5E0E] bg-white/15 h-2 sm:h-2.5 rounded-lg cursor-pointer"
                />
                <div className="flex justify-between text-[9px] sm:text-[10px] font-mono text-zinc-400 mt-1.5 sm:mt-2 font-semibold">
              ...
              <div className="bg-white/[0.05] border border-white/15 p-3.5 sm:p-5 rounded-xl sm:rounded-2xl hover:border-white/25 transition-colors">
                <div className="flex justify-between items-center text-xs font-mono mb-2 sm:mb-3">
                  ...
                  <span
                    className={`font-black text-xs sm:text-sm px-2 sm:px-2.5 py-0.5 rounded-lg border border-white/15 ${
                      gradientPercent > 0
                ...
                <input
                  ...
                  className="w-full accent-[#00F0FF] bg-white/15 h-2 sm:h-2.5 rounded-lg cursor-pointer"
                />
                <div className="flex justify-between text-[9px] sm:text-[10px] font-mono text-zinc-400 mt-1.5 sm:mt-2 font-semibold">
                  <span>-8% (Descent)</span>
              ...
              <div className="bg-white/[0.05] border border-white/15 p-3.5 sm:p-5 rounded-xl sm:rounded-2xl hover:border-white/25 transition-colors">
                ...
                <input
                  ...
                  className="w-full accent-[#D4FF00] bg-white/15 h-2 sm:h-2.5 rounded-lg cursor-pointer"
                />
                <div className="flex justify-between text-[9px] sm:text-[10px] font-mono text-zinc-400 mt-1.5 sm:mt-2 font-semibold">
                  <span>-20° (Port)</span>
              ...
              <div className="bg-white/[0.05] border border-white/15 p-3.5 sm:p-5 rounded-xl sm:rounded-2xl hover:border-white/25 transition-colors">
                ...
                <input
                  ...
                  className="w-full accent-[#E4002B] bg-white/15 h-2 sm:h-2.5 rounded-lg cursor-pointer"
                />
                <div className="flex justify-between text-[9px] sm:text-[10px] font-mono text-zinc-400 mt-1.5 sm:mt-2 font-semibold">

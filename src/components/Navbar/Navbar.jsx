    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="h-7 w-7 rounded-lg bg-gradient-to-br from-[#E4002B]/25 to-[#FF5E0E]/10 border border-[#E4002B]/40 flex items-center justify-center text-[#E4002B] group-hover:border-[#E4002B] group-hover:shadow-[0_0_15px_rgba(228,0,43,0.5)] group-hover:scale-105 transition-all duration-300">
            ...
            <div className="flex items-center gap-2">
              <span className="font-display font-extrabold text-xs sm:text-sm tracking-[0.18em] text-white uppercase group-hover:text-[#E4002B] transition-colors duration-200">
                PINARELLO
              </span>
              <span className="hidden md:inline-block text-[9px] font-mono text-zinc-400 tracking-widest pl-2 border-l border-white/10 font-normal">
                DOGMA <span className="text-[#E4002B] font-semibold">F</span>
              </span>
            </div>
          </a>
